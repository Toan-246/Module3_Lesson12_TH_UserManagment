...
<<div class="container">
    <h1>Create user</h1>
    <a class="btn btn-primary float-end" href="/users">Back to List All Users</a>
    <form action="/users?action=create" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="description" name="country"  value="${user.country}">
        </div>
